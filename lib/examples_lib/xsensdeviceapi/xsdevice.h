...
XDA_DLL_API XsDevice* XsDevice_findDevice(struct XsDevice* thisPtr, const XsDeviceId* deviceid);/*!< \copydoc XsDevice::findDevice(const XsDeviceId&)*/
...
struct XsDevice {
	...
	inline XsDevice* findDevice(const XsDeviceId& deviceid)
	{
