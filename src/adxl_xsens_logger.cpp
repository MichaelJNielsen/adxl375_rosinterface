...
int main(int argc, char **argv)
{
	...
	ros::Publisher clock_pub = n.advertise<std_msgs::Float32>("sensor_clock", 10);
 	...
 	setup_csv();
  	...
  	while (ros::ok())
  	{
		...
		//xsens_read(xsens_data);
    		...
    		time_since_start = csv_updater(accel1_data,accel2_data,xsens_data);

		clock.data = time_since_start;
